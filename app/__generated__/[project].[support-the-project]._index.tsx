/* eslint-disable */
      ...
      import { Box as Box, Fragment as Fragment_1, HtmlEmbed as HtmlEmbed, Button as Button, Text as Text, Image as Image, Heading as Heading, List as List, ListItem as ListItem, Slot as Slot, Paragraph as Paragraph, Separator as Separator } from "@webstudio-is/sdk-components-react";
...
{"Want to support the project? Buy me a coffee here!"}
</Paragraph>
<Link
href={"https://buymeacoffee.com/t342guy"}
target={"_blank"}
prefetch={"intent"}
className={`w-link c1ah9i9y c12sm2j2`}>
<Image
src={"/assets/blue-button_SHSOXQ577SyYIjLVuRIpK.png"}
width={340}
height={306}
loading={"eager"}
className={`w-image csru8nn c1qyy4dh ct02u4h`} />
</Link>
</Box>
</Box>
<Slot>
